...
| `health-snapshot`               | health-query latency, one-snapshot live-state invariants, stable degradation reasons, separately timed PostgreSQL observations, and explicit runtime/history lower bounds beyond 10,000 rows     |
