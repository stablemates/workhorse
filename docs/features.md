...
| Centralized maintenance            | Supported     | An advisory-lock-coordinated worker `maintain_v1` call promotes due jobs, recovers expired leases, and prunes old occurrence keys off the claim hot path. |
...
| Feature                               | Status        | Current behavior and limits                                                                                           |
| ------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------- |
| TypeScript Queue/Worker API           | Supported     | Queue/Worker remain thin protocol clients; workers default to advisory-lock-coordinated maintenance.                  |
