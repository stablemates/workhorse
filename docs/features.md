...
| UI, RBAC, multi-tenancy               | Partial       | The demo ships an operations dashboard (tasks, durable checkpoint inspection, activity, schedules, queues, workers, system health) with audited local mutations; core exposes database and TypeScript protocols only. No RBAC or multi-tenancy. |
