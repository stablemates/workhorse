...
The dashboard counts pending external waits on its system page and marks each waiting task in the
task table. An operator can enter the JSON payload in the task drawer. The dashboard uses
