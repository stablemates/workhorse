# Cancelling a task is a request, not a kill
...
task stays active until its lease expires, and recovery then finalises the cancellation
...
person was allowed to cancel the task. Permission checks belong in your application, before
you call cancel.
