...
- **Status:** Accepted, amended by [ADR 0004](0004-two-cadence-maintenance.md), [ADR 0038](0038-evaluate-cron-occurrences-in-postgresql.md), and [ADR 0047](0047-coordinate-schedules-per-namespace.md)
- **Date:** 2026-07-29
