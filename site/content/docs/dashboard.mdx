...
`@workhorse-js/dashboard` gives your operators a full interface — jobs, attempts, checkpoints,
...
```ts
import { dashboardNodeMiddleware } from "@workhorse-js/dashboard/server";
