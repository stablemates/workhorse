...
`LISTEN/NOTIFY` and pick up new tasks immediately. Without it, workers use bounded polling and keep
the same durable behavior — tasks still run, just on the polling cadence.
