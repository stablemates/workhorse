...
own authorization. The first accepted result resumes the job. An equivalent retry returns the
retained result, while a competing completion cannot overwrite the accepted audit evidence.
