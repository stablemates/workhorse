...
The dashboard's discarded listing is the same set of failed jobs. Its row menu redrives one job,
...
Both confirm first, and both state the same caveat as above: a redriven job is another
