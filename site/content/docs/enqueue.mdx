...
`@workhorse-js/drizzle`, `createPrismaAdapter` from `@workhorse-js/prisma`, `createTypeOrmAdapter`
from `@workhorse-js/typeorm`, or `createKyselyAdapter` from `@workhorse-js/kysely`.
