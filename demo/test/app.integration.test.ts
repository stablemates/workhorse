...
describe("Workhorse demo", () => {
  it("mounts the packaged dashboard at root", async () => {
    ...
    // Without a dev server the host serves the packaged template, which is the production path.
    // Development additionally runs Vite in this process; that is covered by the demo smoke test.
