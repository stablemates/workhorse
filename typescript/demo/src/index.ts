 ...
 *
 * It serves the dashboard from `@stablemates/workhorse-dashboard`, exactly as any consumer would. In
...
if (stagingPool) {
  ...
  demoLogger.info(
    ...
    "DATABASE_URL_SECONDARY is not set; the dashboard serves a single workspace and renders no workspace switcher",
  );
}
