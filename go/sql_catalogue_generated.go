 ...
 WHERE task_id = $1::uuid`,
  ...
  SELECT policy.namespace, policy.queue_name, policy.rate_limit,
   ...
   ORDER BY policy.queue_name LIMIT 100`,
	...
	"set_queue_tier_v1":                         `SELECT workhorse.set_queue_tier_v1($1::text, $2::text, $3::text, $4::text) AS tier`,
	"set_queue_history_v1":                      `SELECT record_attempts, record_claims FROM workhorse.set_queue_history_v1($1::text, $2::boolean, $3::boolean)`,
...
var protocolStatementRegistry = map[string]string{
	...
	"complete_many_and_claim_v1":   `SELECT * FROM workhorse.complete_many_and_claim_v1($1::text, $2::uuid[], $3::bigint[], $4::jsonb[], $5::text, $6::integer, $7::integer)`,
...
var adminStatementRegistry = map[string]string{
	...
	"set_queue_history": `SELECT record_attempts, record_claims FROM workhorse.set_queue_history_v1($1::text,$2::boolean,$3::boolean)`,
