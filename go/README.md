...
```bash
npx --package @stablemates/workhorse@0.2.1 workhorse schema install
```
...
Requires Go 1.25 or newer and PostgreSQL 15 through 18. pgx v5.11.0 is the minimum and the tested version.
