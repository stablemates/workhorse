...
type DashboardCheckpointValue struct {
	Name       string  `json:"name"`
	Value      any     `json:"value"`
	ValueBytes float64 `json:"valueBytes"`
...
type DashboardCronPage struct {
	...
	Maintenance struct {
		...
		Routines []struct {
			...
			RecordedRunCount float64                   `json:"recordedRunCount"`
			Runs             []DashboardMaintenanceRun `json:"runs"`
		} `json:"routines"`
	} `json:"maintenance"`
}
...
type DashboardMaintenanceRun struct {
	ID           string  `json:"id"`
	StartedAt    string  `json:"startedAt"`
	CompletedAt  string  `json:"completedAt"`
	DurationMs   float64 `json:"durationMs"`
	...
	Phases       []struct {
		...
		ExpiredLeases *float64 `json:"expiredLeases,omitempty"`
		Retried       *float64 `json:"retried,omitempty"`
	} `json:"phases"`
}
...
type DashboardTaskDetail struct {
	...
	CanSignal         bool                               `json:"canSignal"`
	Payload           any                                `json:"payload"`
	PayloadBytes      float64                            `json:"payloadBytes"`
	...
	Current    struct {
		...
		Outcome *struct {
			...
			ResultOmitted bool    `json:"resultOmitted"`
			Error         any     `json:"error"`
		} `json:"outcome"`
		Error any `json:"error"`
	} `json:"current"`
...
type CheckpointValueInput struct {
	ID   string `json:"id"`
	Name string `json:"name"`
}
...
type SetSchedulePausedOutput struct {
	Paused bool `json:"paused"`
}
...
func ValidateTasksCursorInput(value any) error { return ValidateInput("tasksCursor", value) }
...
func ValidateCheckpointValueInput(value any) error { return ValidateInput("checkpointValue", value) }
func ValidateTaskValueInput(value any) error       { return ValidateInput("taskValue", value) }
...
func ValidateSetSchedulePausedInput(value any) error {
	return ValidateInput("setSchedulePaused", value)
}
...
func ValidateRedriveTaskInput(value any) error { return ValidateInput("redriveTask", value) }
func ValidateRedriveDeadLettersInput(value any) error {
	return ValidateInput("redriveDeadLetters", value)
}
