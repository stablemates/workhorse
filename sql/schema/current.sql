...
-- The generic JSON input makes PostgreSQL underestimate the rows that reach the activity group.
-- Prefer the spill-capable hash aggregate over a disk sort of every matching task.
...
INSERT INTO workhorse.schema_migration(version, description) VALUES
  ...
  (27, 'claim policy limited tasks as a set')
ON CONFLICT DO NOTHING;
