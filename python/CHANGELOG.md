...
and publishes from its own tag. It carries the version the TypeScript packages and the Go module
carry, because all three tags name one commit.
...
`python/v0.1.1`. Workhorse stays a public beta on the `0.x` line.
